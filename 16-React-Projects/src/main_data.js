import one from './pages/data/1.png'
import two from './pages/data/2.png'
import three from './pages/data/3.png'
import four from './pages/data/4.png'
import five from './pages/data/5.png'
import six from './pages/data/6.png'
import seven from './pages/data/7.png'
import eight from './pages/data/8.png'
import nine from './pages/data/9.png'
import ten from './pages/data/10.png'
import eleven from './pages/data/11.png'
import twelve from './pages/data/12.png'
import thirteen from './pages/data/13.png'
import fourteen from './pages/data/14.png'
import fifteen from './pages/data/15.png'
import bonus from './pages/data/bonus.jpg'
...
const main_data = [
    ...
    {
        id: 16,
        name: "This website (React Projects)",
        img: bonus,
        url: "#",
        github: "",
        details: "16-bonus"
